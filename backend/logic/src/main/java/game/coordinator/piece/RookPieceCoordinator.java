...
public class RookPieceCoordinator extends BasicChessPieceCoordinator {
    public RookPieceCoordinator(Map<ChessPieceType, BasicChessPieceCoordinator> coordinatorMap) {
